...
public class ConfigProcessorGenerator extends AbstractGenerator<POMModel> {

    private final String GROUP_ID = "org.springframework.boot";
    private final String ARTIFACT_ID = "spring-boot-configuration-processor";

    private ConfigProcessorGenerator(POMModel model, JTextComponent component) {
        super(model, component);
    }

    @MimeRegistration(mimeType = Constants.POM_MIME_TYPE, position = 950, service = CodeGenerator.Factory.class)
    public static class Factory implements CodeGenerator.Factory {
        ...
        public List<? extends CodeGenerator> create(Lookup context) {
            ...
            if (model != null) {
                toRet.add(new ConfigProcessorGenerator(model, component));
            }
            return toRet;
        }
    }
    ...
    public String getDisplayName() {
        return "Spring Boot config. processor";
    }
