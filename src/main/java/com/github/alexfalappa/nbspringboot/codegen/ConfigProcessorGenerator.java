...
public class ConfigProcessorGenerator implements CodeGenerator {
     ...
     */
    private ConfigProcessorGenerator(Lookup context) { // Good practice is not to save Lookup outside ctor
    ...
    public static class Factory implements CodeGenerator.Factory {
        ...
        public List<? extends CodeGenerator> create(Lookup context) {
            return Collections.singletonList(new ConfigProcessorGenerator(context));
        }
    }
    ...
    public String getDisplayName() {
        return "Springboot config. processor";
    }
