...
public final class ControllerWizardIterator implements WizardDescriptor.InstantiatingIterator<WizardDescriptor> {
    ...
    public void initialize(WizardDescriptor wizard) {
        ...
        panel = JavaTemplates.createPackageChooser(project, groups, new ControllerWizardPanel1(), true);
