...
/**
 * Wizard Iterator for new reactive RestController class file wizard.
 *
...
public final class ReactRestControllerWizardIterator implements WizardDescriptor.InstantiatingIterator<WizardDescriptor> {
